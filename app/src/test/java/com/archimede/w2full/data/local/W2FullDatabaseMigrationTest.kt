...
class W2FullDatabaseMigrationTest {
    @Test
    fun migration1To3PreservesVehicleAndRefuelingDataAndCreatesMimitTables() {
        ...
        val database = Room.databaseBuilder(context, W2FullDatabase::class.java, databaseName)
            .addMigrations(W2FullDatabase.MIGRATION_1_2, W2FullDatabase.MIGRATION_2_3)
    ...
    @Test
    fun migration2To3PreservesMimitCacheAndCreatesEmptyHistory() {
        val context = ApplicationProvider.getApplicationContext<Context>()
        ...
        val database = Room.databaseBuilder(context, W2FullDatabase::class.java, databaseName)
            .addMigrations(W2FullDatabase.MIGRATION_2_3)
            .allowMainThreadQueries()
            .build()
